...
class AdUnitDataSet_VAD_category(CustomDataset):
                ...
                if classwise:  # Compute per-category AP
                    ...
                    for idx, catId in enumerate(self.cat_ids):
                        ...
                        if recall.size:
                            ...
                            ap = float('nan')
                        recalls_per_category.append(
                            (f'{nm["name"]}', f'{float(ap):0.3f}'))

                    num_columns = min(6, len(recalls_per_category) * 2)
                    results_flatten = list(
                        itertools.chain(*recalls_per_category))
